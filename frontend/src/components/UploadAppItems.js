const UploadAppItems = ({ resume, handleResumeChange, onSubmit, jobDescription, handleJobDescriptionChange, handleCloseModal }) => {
  return (
    <>
              ...
              <form onSubmit={onSubmit} className="container col-10 mt-4">
                ...
                <div>
                  <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" className="btn btn-primary" onClick={handleCloseModal}>Save</button>
                  </div>
                </div>
              </form>
            </div>
