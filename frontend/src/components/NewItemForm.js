const NewItemForm = ({ onSubmit, newCompName, handleCompChange, newPos, handlePosChange, newContactName, handleContactChange, newEmail, handleEmailChange, hook, handleCloseModal }) => {
  return (
    <div>
              ...
              <form onSubmit={onSubmit} className="container col-10 mt-4">
                ...
                <div>
                  <div  className="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button id="newEntrySubmit" type="submit" className="btn btn-primary" onClick={handleCloseModal}>Save changes</button>
                  </div>
                </div>
              </form>
            </div>
